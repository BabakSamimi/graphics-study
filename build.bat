...
SET LINKER_FLAGS=opengl32.lib shell32.lib user32.lib kernel32.lib gdi32.lib %ROOT%\vendors\GLFW\lib-vc2022\glfw3_mt.lib %ROOT%\vendors\assimp\lib\assimp-vc143-mtd.lib
